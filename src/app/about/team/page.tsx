...
const LEADERSHIP = [
  ...
  },
  {
    ...
    role: "Senior Architect & Head of Design",
    image: "/images/team/aakanksha-mahajan.webp",
    bio: "Consulting architect and smart home expert who brings an architect's lens to home automation — designing premium residences, hospitality projects, and commercial environments where technology disappears into the design. Specializes in intelligent spaces for builders, architects, and HNI homeowners.",
    certifications: ["Architecture", "Smart Home Design", "Project Management"],
    linkedin: "https://www.linkedin.com/in/aakanksha-mahajan-gmhs/",
  },
];
