...
## Home Office Automation in India: Lighting, Productivity & WFH Setup
...
| Tier | Scope | Cost (₹) |
|------|-------|----------|
| **Starter / DIY retrofit** | Tunable Wi-Fi bulbs + 2 smart plugs + smart AC controller + router mini-UPS | ₹15,000–40,000 |
| **Mid (smart, app-controlled)** | Philips Hue lighting + mesh Wi-Fi + smart AC + 1 motorized blind + busy light + UPS | ₹60,000–1,50,000 |
| **Premium / pro-installed** | KNX or Lutron lighting + UniFi/Aruba network + structured cabling + motorized blinds + integrated meeting automation + backup | ₹2,50,000–6,00,000+ |
...
**Start with the basics:** [What Is Home Automation](/blog/what-is-home-automation), and since reliable connectivity is the foundation of a WFH setup, our [home networking service](/services/home-networking).
